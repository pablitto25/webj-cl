    ...
    <div className='containerHomeCard'>
      <div id="carouselExampleProductHome" className="carousel slide">
        <div className="carousel-inner border-0">
          ...
          <button className="carousel-control-prev" type="button" data-bs-target="#carouselExampleProductHome"
            data-bs-slide="prev">
            <span className="carousel-control-prev-icon" aria-hidden="true"></span>
            <span className="visually-hidden">Previous</span>
          </button>
          <button className="carousel-control-next" type="button" data-bs-target="#carouselExampleProductHome"
            data-bs-slide="next">
