...
import imagen1 from '../conocimiento/assests/Explorer1000.webp'
        ...
        <div>
            ...
            <section className='NotaConteiner' >
                <div className='NotaTexConteiner'>
                    ...
                    {/* inicio nueva nota */}
                    <p>
                        Trabajar como <strong>guía de turismo</strong> es, en verdad, desafiante: tienes que conocer en profundidad la historia, la fauna y la flora del lugar visitado, al mismo tiempo que tenés que liderar un grupo.
                    ...
                    <div className='NotaImgConteiner'>
                        <img src={imagen1} className='imageStyle' alt='imagen' />
                    </div>
                    <p><strong>¿Cómo la estación portátil Explorer 1000 podría facilitar tu trabajo?</strong><br />
